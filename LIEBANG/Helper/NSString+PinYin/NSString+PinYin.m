...
- (NSArray *)arrayWithPinYinFirstLetterFormat
{
    ...
    for (FriendModel *model in self) {
        NSString *firstLetter = [model.userName getFirstLetter];
...
//            }];
            [array sortUsingComparator:^NSComparisonResult(id obj1, id obj2) {
                FriendModel *word1 = obj1;
                FriendModel *word2 = obj2;
                return [word1.userName localizedCompare:word2.userName];
            }];
