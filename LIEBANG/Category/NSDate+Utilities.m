...
{
    NSCalendar *gregorianCalendar = [[NSCalendar alloc] initWithCalendarIdentifier:NSCalendarIdentifierGregorian];
    [gregorianCalendar setFirstWeekday:startWeekDay];
    NSDateComponents *comps = [gregorianCalendar components:NSCalendarUnitYear | NSCalendarUnitMonth |  NSCalendarUnitDay fromDate:self];
    NSDate *newDate = [gregorianCalendar dateFromComponents:comps];
    NSInteger indexInMonthWithWeekDay = [gregorianCalendar ordinalityOfUnit:NSCalendarUnitWeekday inUnit:NSCalendarUnitWeekOfMonth forDate:newDate];
    return indexInMonthWithWeekDay;
}

- (NSInteger)numDaysInMonth;
{
    NSRange rng = [[NSDate currentCalendar] rangeOfUnit:NSCalendarUnitDay inUnit:NSCalendarUnitMonth forDate:self];
...
- (NSCalendarWeekDay) weekday
{
	NSDateComponents *components = [[NSDate currentCalendar] components:componentFlags fromDate:self];
	return (NSCalendarWeekDay)(components.weekday);
}
