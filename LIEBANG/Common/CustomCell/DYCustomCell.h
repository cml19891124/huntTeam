...
@protocol DYCustomCellDelegate <NSObject>

@optional

/**
 *  DYCustomCell's event.
 *
 *  @param cell  DYCustomCell type class.
 *  @param event Event data.
 */
- (void)DYCustomCell:(DYCustomCell *)cell event:(id)event;

@end

@interface DYCustomCell : UITableViewCell

#pragma mark - Propeties.

/**
 *  DYCustomCell's delegate.
 */
@property (nonatomic, weak) id <DYCustomCellDelegate> delegate;

/**
 *  DYCustomCell's dataAdapter.
 */
...
/**
 ...
 @param indexPath The indexPath.
 */
- (void)loadContentWithAdapter:(CellDataAdapter *)dataAdapter delegate:(id <DYCustomCellDelegate>)delegate indexPath:(NSIndexPath *)indexPath;
...
/**
 ...
 @param indexPath The indexPath.
 */
- (void)loadContentWithAdapter:(CellDataAdapter *)dataAdapter delegate:(id <DYCustomCellDelegate>)delegate tableView:(UITableView *)tableView
...
@interface UITableView (DYCustomCell)

- (DYCustomCell *)dequeueReusableCellAndLoadDataWithAdapter:(CellDataAdapter *)adapter indexPath:(NSIndexPath *)indexPath;

- (DYCustomCell *)dequeueReusableCellAndLoadDataWithAdapter:(CellDataAdapter *)adapter delegate:(id <DYCustomCellDelegate>)delegate
                                                indexPath:(NSIndexPath *)indexPath;
