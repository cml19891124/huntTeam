...
-(UITableView *)leftTable{
    if (!_leftTable) {
        _leftTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kDeviceWidth/2 - 15, 0) style:UITableViewStylePlain];
...
-(UITableView *)rightTable{
    if (!_rightTable) {
        _rightTable = [[UITableView alloc]initWithFrame:CGRectMake(0, 0, kDeviceWidth/2+15, 0) style:UITableViewStylePlain];
